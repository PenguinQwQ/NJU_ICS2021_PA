...
//REM
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem, R, R(dest) = (src2 == 0) ? (src1) : ((int)src1 % (int)src2));
//SLTIU
...
//SRL
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl, R , R(dest) = (src1 >> (src2 & 0x01F)));
//SLL
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll, R , R(dest) = (src1 << (src2 & 0x01F)));
//SRA
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra, R , R(dest) = (((int)src1) >> (src2 & 0x01F)));
//SB
...
//SLLI
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli, I, R(dest) = (src1 << (imm & 0x01F)));
//SRLI
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli, I, R(dest) = (src1 >> (imm & 0x01F)));
//SRAI
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai, I, R(dest) = (((int)src1) >> (imm & 0x01F)));
//LBU
...
/*
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, R(dest) = (unsigned int)(((unsigned long long)src1 * src2 ) >> 32));
*/
//DIV
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div, R, R(dest) = (src2 == 0) ? (-1) : ((int)src1 / (int)src2));
//DIVU
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu, R, R(dest) = (src2 == 0) ? ((uint32_t)-1) : (src1 / src2));
//REMU
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu, R, R(dest) = (src2 == 0) ? (src1) : (src1 % src2));
