...
//SB
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sb, S, Mw(src1 + imm, 1, src2 & 11111111));
//SH
  INSTPAT("??????? ????? ????? 001 ????? 01000 11", sh, S, Mw(src1 + imm, 2, src2 & 1111111111111111));
//LB
...
//LH
  INSTPAT("??????? ????? ????? 001 ????? 00000 11", lh, I, R(dest) = Mr(src1 + imm, 2));
//LBU
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu , I, R(dest) = (int)Mr(src1 + imm, 1));
//LHU
  INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu , I, R(dest) = (int)Mr(src1 + imm, 2));
