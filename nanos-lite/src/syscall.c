...
void do_syscall(Context *c) {
  ...
  switch (a[0]) {
    ...
    case SYS_execve:  panic("in execve"); c->GPRx = execve((const char *)a[1], (char **const)a[2], (char **const)a[3]); break;//c->GPRx = sys_execve((const char *)a[1],(char * const*)a[2],(char *const*)a[3]); break;
